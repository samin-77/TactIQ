...
export default function Fantasy() {
  ...
  const remainingBudget = 150.0 - totalCost;
  ...
  async function handleSubmitTeam(e) {
    ...
    if (!isValidSquad) {
      ...
      if (totalCost > 150.0) {
        return setError(`Budget exceeded! You have spent ${totalCost.toFixed(1)}m. Max budget allowed is 150.0m.`);
      }
      if (squadCounts.GK !== 1) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <p className="animate-fade-in-up delay-1" style={{ color: 'var(--text-secondary)', marginTop: '-1rem' }}>Build your dream squad of 11 World Cup stars within a 150.0m budget. Be tactical with your picks!</p>
