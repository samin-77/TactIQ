...
import { Calendar, Play, CheckCircle, Send, ArrowUp, ArrowDown, Trash, MessageSquare, Clock, ShieldAlert } from 'lucide-react';
                    ...
                    {existingPrediction ? (
                      <div>
                        ...
                        {existingPrediction.points_earned !== null && (
                          <div style={{ marginTop: '0.5rem', fontWeight: 700, color: existingPrediction.points_earned > 0 ? 'var(--color-green)' : 'var(--color-red)' }}>
                            Points Earned: +{existingPrediction.points_earned}
                          </div>
                        )}
                      </div>
                    ) : (
