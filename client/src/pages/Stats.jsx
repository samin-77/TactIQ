...
const goldenBootData = [
  { rank: 1, name: 'Kylian Mbappé', team: 'France', teamCode: 'FRA', position: 'FW', goals: 10, assists: 4, minutes: 782, yellowCards: 1, redCards: 0 },
  { rank: 2, name: 'Lionel Messi', team: 'Argentina', teamCode: 'ARG', position: 'FW', goals: 8, assists: 1, minutes: 655, yellowCards: 1, redCards: 0 },
  { rank: 3, name: 'Erling Haaland', team: 'Norway', teamCode: 'NOR', position: 'FW', goals: 7, assists: 2, minutes: 598, yellowCards: 0, redCards: 0 },
  { rank: 4, name: 'Jude Bellingham', team: 'England', teamCode: 'ENG', position: 'MF', goals: 7, assists: 3, minutes: 712, yellowCards: 2, redCards: 0 },
  { rank: 5, name: 'Harry Kane', team: 'England', teamCode: 'ENG', position: 'FW', goals: 6, assists: 2, minutes: 630, yellowCards: 0, redCards: 0 },
  { rank: 6, name: 'Ousmane Dembélé', team: 'France', teamCode: 'FRA', position: 'FW', goals: 5, assists: 3, minutes: 520, yellowCards: 1, redCards: 0 },
  { rank: 7, name: 'Michael Olise', team: 'France', teamCode: 'FRA', position: 'MF', goals: 6, assists: 4, minutes: 620, yellowCards: 0, redCards: 0 },
  { rank: 8, name: 'Lautaro Martínez', team: 'Argentina', teamCode: 'ARG', position: 'FW', goals: 6, assists: 2, minutes: 490, yellowCards: 0, redCards: 0 },
  { rank: 9, name: 'Yangel Moreno', team: 'Venezuela', teamCode: 'VEN', position: 'FW', goals: 6, assists: 1, minutes: 510, yellowCards: 1, redCards: 0 },
  { rank: 10, name: 'Ferran Torres', team: 'Spain', teamCode: 'ESP', position: 'FW', goals: 5, assists: 2, minutes: 540, yellowCards: 0, redCards: 0 },
  { rank: 11, name: 'Lamine Yamal', team: 'Spain', teamCode: 'ESP', position: 'FW', goals: 5, assists: 3, minutes: 580, yellowCards: 1, redCards: 0 },
  { rank: 12, name: 'Bruno Fernandes', team: 'Portugal', teamCode: 'POR', position: 'MF', goals: 5, assists: 2, minutes: 590, yellowCards: 0, redCards: 0 },
  { rank: 13, name: 'Mikel Oyarzabal', team: 'Spain', teamCode: 'ESP', position: 'FW', goals: 4, assists: 1, minutes: 420, yellowCards: 0, redCards: 0 },
  { rank: 14, name: 'Vinícius Júnior', team: 'Brazil', teamCode: 'BRA', position: 'FW', goals: 4, assists: 2, minutes: 480, yellowCards: 1, redCards: 0 },
  { rank: 15, name: 'Cody Gakpo', team: 'Netherlands', teamCode: 'NED', position: 'FW', goals: 4, assists: 1, minutes: 460, yellowCards: 0, redCards: 0 },
  { rank: 16, name: 'Alexander Isak', team: 'Sweden', teamCode: 'SWE', position: 'FW', goals: 4, assists: 0, minutes: 390, yellowCards: 0, redCards: 0 },
  { rank: 17, name: 'Jonathan David', team: 'Canada', teamCode: 'CAN', position: 'FW', goals: 4, assists: 1, minutes: 420, yellowCards: 0, redCards: 0 },
  { rank: 18, name: 'Neymar Jr', team: 'Brazil', teamCode: 'BRA', position: 'FW', goals: 3, assists: 2, minutes: 380, yellowCards: 1, redCards: 0 },
  { rank: 19, name: 'Bukayo Saka', team: 'England', teamCode: 'ENG', position: 'FW', goals: 3, assists: 3, minutes: 520, yellowCards: 0, redCards: 0 },
  { rank: 20, name: 'Viktor Gyökeres', team: 'Sweden', teamCode: 'SWE', position: 'FW', goals: 4, assists: 1, minutes: 350, yellowCards: 0, redCards: 0 },
  { rank: 21, name: 'Florian Wirtz', team: 'Germany', teamCode: 'GER', position: 'MF', goals: 3, assists: 3, minutes: 510, yellowCards: 0, redCards: 0 },
  { rank: 22, name: 'Cristiano Ronaldo', team: 'Portugal', teamCode: 'POR', position: 'FW', goals: 3, assists: 1, minutes: 380, yellowCards: 0, redCards: 0 },
];
